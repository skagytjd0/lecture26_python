...
if __name__ == '__main__':
    ...
    print(ac_list)
    dao.insert_account(account('111111', 'skagytjd', 10000, '1234'))
    dao.insert_account(account('111112', 'gy', 20000, '1234'))
    dao.insert_account(account('111113', 'gy', 200000, '1234'))
    for account in dao.select_all_accounts():
        print(account)
    print(dao.select_account_by_account_no('111114'))
    for account in dao.select_accounts_by_member_id('skagytjd'):
        print(account)
    print()
    print(dao.select_account_by_account_no('111112'))
    dao.update_account('111112', account('111112', 'gy', 300000, '1234'))
    print(dao.select_account_by_account_no('111112'))
    print()
