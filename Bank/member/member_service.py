...
if __name__ == '__main__':
    ...
    ms.join(Member('skagytjd', '1234', '남효성'))
    ms.join(Member('ska', '1111', '효'))
    ...
    ms.logout()
    print(ms.current_user)
    print(ms.view_member_info('ska'))
    ms.login(MemberService.ADMIN_ID, MemberService.ADMIN_PASSWORD)
    print(ms.update_member_password('skagytjd', '1234', '4321'))
    print(ms.view_member_info('skagytjd'))
    print(ms.remove_member('skagytjd'))
    print(ms.view_member_info('skagytjd'))