...
class ConsoleMarket:
    ...
    # 규칙준수: range()를 기반으로 한 리스트 인덱스 출력 구조 유지
    ...
    def run_market_menu(self):
        while True:
            ...
            if menu == 0:
                ...
                if self.usv.current_user == None: return # 서브메뉴에서 탈퇴 시 완전히 탈출
    ...
    def run_admin_menu(self):
        while True:
            ...
            elif menu == 3: self.run_admin_bid_win_menu() # 수정 요구 명세: 입찰/낙찰내역 서브루프 통합
    ...
    def run_admin_order_menu(self):
        while True:
            ...
            if menu == 0: return
            elif menu == 1: self.menu_list_items() # 경매품보기 매핑
